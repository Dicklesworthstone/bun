...
export const createSocketPair: () => [number, number] = $newRustFunction("runtime/socket/socket_body.rs", "jsCreateSocketPair", 0);
...
export const setSocketOptions: setSocketOptionsFn = $newRustFunction("runtime/socket/socket_body.rs", "jsSetSocketOptions", 3);
