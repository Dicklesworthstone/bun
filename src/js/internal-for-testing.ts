...
export const createSocketPair: () => [number, number] = $newRustFunction("runtime/socket/socket.rs", "jsCreateSocketPair", 0);
...
export const setSocketOptions: setSocketOptionsFn = $newRustFunction("runtime/socket/socket.rs", "jsSetSocketOptions", 3);
